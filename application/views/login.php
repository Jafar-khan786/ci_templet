...
<body>
    <div class="main-wrapper">
        ...
        <!-- Login box.scss -->
        <!-- ============================================================== -->
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center" style="background:url(<?php echo base_url();?>upload/admin/Healthcare.jpg);  background-position: center;
  background-repeat: no-repeat;
  background-size: cover;">
            <div class="auth-box">
                <div id="loginform">
                    <div class="logo">
                        <span class="db" style="font-size: 18px; font-weight: 600;"><!--<img src="" alt="logo" />-->YQ</span>
                    ...
                    <div class="row">
                        <div class="col-12">
             <form class="form-horizontal m-t-20"  method="POST" action="<?php echo base_url();?>Login/log">
                ...
                <div id="recoverform">
                    <div class="logo">
                        <span class="db" style="font-size: 18px; font-weight: 600;">Doctors</span>
                        <h5 class="font-medium m-b-20">Recover Password</h5>
                        <span>Enter your Email Address!</span>
                    </div>
                    <div class="row m-t-20">
                        <!-- Form -->
                        <form method="POST" class="col-12" action="<?php echo base_url();?>Login/forget">
                            <!-- email -->
                            <div class="form-group row">
                                <div class="col-12">
